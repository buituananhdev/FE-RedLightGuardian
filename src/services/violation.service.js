...
export const getAllViolations = async (key_word = '', page = 1, pageSize = 10) => {
    return await axiosApiInstance.get(`/violations?key_word=${key_word}&page=${page}&pageSize=${pageSize}`)
}
